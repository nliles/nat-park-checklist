...
export const PARK_INFO: ParkInfoDict = {
  [ParkDesignation.ALL_DESIGNATIONS]: {
    codes: ALL_DESIGNATIONS,
    formattedParks: [KINGS_CANYON_NAT_PARK, SEQUOIA_NAT_PARK, FORT_CAROLINE_NAT_MEMORIAL, HOHOKAM_NAT_MONUMENT, LAKE_CHELAN_NRA, LAKE_ROSS_NRA, JDR_MEMORIAL_PARKWAY, DENALI_NATIONAL_PRESERVE,
      GATES_OF_ARCTIC_PRESERVE,
      GLACIER_BAY_PRESERVE,
      GREAT_SAND_DUNES_PRESERVE
    ],
